...
Vitis-AI /workspace > ls
 docker          index.html       quantize_compile   tes_GPU_version                                                     vitis-ai-tutorials
 docker_run.sh   LICENSE          README.md          tf_yolov4_coco_416_416_60.3G_2.5                                    VOC2012
 docs            model_zoo        reference_design   third_party                                                         yolov4_tiny
 examples        new_pytorch      setup              VERSION.txt
 follow.md       old_screenshot   src               'Vitis_AI_GPU_Run_Command_Screenshot from 2023-02-20 12-31-56.png'
Vitis-AI /workspace > conda activate vitis-ai-tensorflow
(vitis-ai-tensorflow) Vitis-AI /workspace > ls
 docker          index.html       quantize_compile   tes_GPU_version                                                     vitis-ai-tutorials
 docker_run.sh   LICENSE          README.md          tf_yolov4_coco_416_416_60.3G_2.5                                    VOC2012
 docs            model_zoo        reference_design   third_party                                                         yolov4_tiny
 examples        new_pytorch      setup              VERSION.txt
 follow.md       old_screenshot   src               'Vitis_AI_GPU_Run_Command_Screenshot from 2023-02-20 12-31-56.png'
(vitis-ai-tensorflow) Vitis-AI /workspace > cd quantize_compile/
(vitis-ai-tensorflow) Vitis-AI /workspace/quantize_compile > exit
exit
(base) logictronix@logictronix:~/Vitis_AI_latest/Vitis-AI$ ./docker_run.sh xilinx/vitis-ai-gpu:2.5
NOTICE:  BY INVOKING THIS SCRIPT AND USING THE SOFTWARE INSTALLED BY THE
SCRIPT, YOU AGREE ON BEHALF OF YOURSELF AND YOUR EMPLOYER (IF APPLICABLE)
...
(vitis-ai-tensorflow2) Vitis-AI /workspace > ls
 docker          index.html       quantize_compile   tes_GPU_version                                                     vitis-ai-tutorials
 docker_run.sh   LICENSE          README.md          tf_yolov4_coco_416_416_60.3G_2.5                                    VOC2012
 docs            model_zoo        reference_design   third_party                                                         yolov4_tiny
 examples        new_pytorch      setup              VERSION.txt
 follow.md       old_screenshot   src               'Vitis_AI_GPU_Run_Command_Screenshot from 2023-02-20 12-31-56.png'
(vitis-ai-tensorflow2) Vitis-AI /workspace > cd quantize_compile/tf2_resnet50_imagenet_224_224_7.76G_1.4
(vitis-ai-tensorflow2) Vitis-AI /workspace/quantize_compile/tf2_resnet50_imagenet_224_224_7.76G_1.4 > ls
arch_kv260.json  code  compile.md  data  float  quantized  readme.md  requirements.txt
(vitis-ai-tensorflow2) Vitis-AI /workspace/quantize_compile/tf2_resnet50_imagenet_224_224_7.76G_1.4 > exit
exit
(base) logictronix@logictronix:~/Vitis_AI_latest/Vitis-AI$ ./docker_run.sh xilinx/vitis-ai-gpu:2.5
NOTICE:  BY INVOKING THIS SCRIPT AND USING THE SOFTWARE INSTALLED BY THE
SCRIPT, YOU AGREE ON BEHALF OF YOURSELF AND YOUR EMPLOYER (IF APPLICABLE)
...
(vitis-ai-tensorflow) Vitis-AI /workspace/quantize_compile/tf_resnetv1_50_imagenet_224_224_6.97G_3.0 > ls
arch_kv260.json  code  compile.md  compile_result_kv260  data  float  quantized  readme.md  requirements.txt
(vitis-ai-tensorflow) Vitis-AI /workspace/quantize_compile/tf_resnetv1_50_imagenet_224_224_6.97G_3.0 > vai_c_tensorflow --arch ./arch_kv260.json  -f quantized/quantized_baseline_6.96B_919.pb --output_dir compile_result_kv260 -n tf_resnet50
**************************************************
* VITIS_AI Compilation - Xilinx Inc.
**************************************************
[INFO] Namespace(batchsize=1, inputs_shape=None, layout='NHWC', model_files=['quantized/quantized_baseline_6.96B_919.pb'], model_type='tensorflow', named_inputs_shape=None, out_filename='/tmp/tf_resnet50_0x101000016010406_org.xmodel', proto=None)
...
[INFO] parse raw model     :100%|██████████████████████████████████████████████████████████| 270/270 [00:00<00:00, 12643.60it/s]             
[INFO] infer shape (NHWC)  :100%|██████████████████████████████████████████████████████████| 331/331 [00:00<00:00, 3841.73it/s]              
[INFO] perform level-0 opt :100%|██████████████████████████████████████████████████████████| 3/3 [00:00<00:00, 199.54it/s]                   
[INFO] perform level-1 opt :100%|██████████████████████████████████████████████████████████| 7/7 [00:00<00:00, 230.93it/s]                   
[INFO] generate xmodel     :100%|██████████████████████████████████████████████████████████| 219/219 [00:00<00:00, 1280.60it/s]              
[INFO] dump xmodel: /tmp/tf_resnet50_0x101000016010406_org.xmodel
...
[UNILOG][INFO] The meta json is saved to "/workspace/quantize_compile/tf_resnetv1_50_imagenet_224_224_6.97G_3.0/compile_result_kv260/meta.json"
[UNILOG][INFO] The compiled xmodel is saved to "/workspace/quantize_compile/tf_resnetv1_50_imagenet_224_224_6.97G_3.0/compile_result_kv260/tf_resnet50.xmodel"
[UNILOG][INFO] The compiled xmodel's md5sum is f2cd9c89e28f01f36d7342130ddb2251, and has been saved to "/workspace/quantize_compile/tf_resnetv1_50_imagenet_224_224_6.97G_3.0/compile_result_kv260/md5sum.txt"
